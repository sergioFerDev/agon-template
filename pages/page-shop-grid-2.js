          ...
          <div className="row dr-rtl">
            <div className="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 dr-ltr">
                  ...
                  <div className="icon-layout mr-10 text-body-text color-gray-500">Show:<div className="color-green-900 d-inline">
                    <div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>50</span><i className="fi-rr-angle-small-down"></i></button>
                      <ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage">
                        <li>
                          <Link href="#"><a className="dropdown-item active">50</a></Link></li>
                        <li>
                          <Link href="#"><a className="dropdown-item">100</a></Link></li>
                        <li>
                          <Link href="#"><a className="dropdown-item">150</a></Link></li>
                      </ul>
                    </div>
                  </div>
                  </div>
                  <div className="icon-sort text-body-text color-gray-500">Sort by:<div className="color-green-900 d-inline">
                    <div className="dropdown dropdown-sort"><button className="btn dropdown-toggle" id="dropdownSort" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static"><span>Featured</span><i className="fi-rr-angle-small-down"></i></button>
                      <ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownSort">
                        <li>
                          <Link href="#"><a className="dropdown-item active">Featured</a></Link></li>
                        <li>
                          <Link href="#"><a className="dropdown-item">Rating</a></Link></li>
                        <li>
                          <Link href="#"><a className="dropdown-item">Low Price</a></Link></li>
                      </ul>
                    </div>
                  </div>
                  </div>
              ...
              <div className="paginations">
                <ul className="pager">
                  <li>
                    <Link href="#"><a className="prev-page"></a></Link></li>
                  <li>
                    <Link href="#"><a>1</a></Link></li>
                  <li>
                    <Link href="#"><a>2</a></Link></li>
                  <li>
                    <Link href="#"><a>3</a></Link></li>
                  <li>
                    <Link href="#"><a className="page-dotted"></a></Link></li>
                  <li>
                    <Link href="#"><a className="next-page"></a></Link></li>
                </ul>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 dr-ltr">
              <div className="sidebar">
                ...
                <div className="widget-content">
                  ...
                  <div className="mt-0">
                    <Link href="#"><a className="btn btn-filter">Filter</a></Link></div>
                </div>
              </div>
              <div className="sidebar">
                <div className="widget-title">
                  ...
                  <ul className="list-products-sidebar">
                    <li>
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#"><a><img src="/assets/imgs/page/shop1/sp5.png" alt="agon" /></a></Link></div>
                    ...
                    <li>
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#"><a><img src="/assets/imgs/page/homepage5/sp1.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                          <Link href="#"><a>
                    ...
                    <li>
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#"><a><img src="/assets/imgs/page/homepage5/sp2.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                          <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                          </a></Link>
                    ...
                    <li>
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#"><a><img src="/assets/imgs/page/homepage5/sp3.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                          <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                          </a></Link>
                    ...
                    <li>
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#"><a><img src="/assets/imgs/page/shop1/sp4.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                          <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                          </a></Link>
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 text-end">
                <Link href="/page-signup"><a className="btn btn-default hover-up icon-arrow-right mt-10">Browse All</a></Link></div>
            </div>
          </div>
          <div className="container mt-70">
            <div className="row">
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/pc.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/headphone.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/laptop.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/mobile.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/printer.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/book.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/tablet.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/usb.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/mouse.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/security.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/watch.svg" alt="agon" /></a></Link></div>
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                  <div className="category-img">
                    <Link href="#"><a><img src="/assets/imgs/page/shop1/scan.svg" alt="agon" /></a></Link></div>
          ...
          <div className="container">
            <div className="box-green box-green-2 bdr-18">
              ...
              <div className="mt-60">
                ...
                <Link href="#"><a><img src="/assets/imgs/page/homepage5/google-play.svg" alt="agon" /></a></Link></div>
